    ...
    <div>
      ...
      <form className='new-invoice-form'>
        <div className='first-row'>
          <input required onChange={e => { setTo(e.target.value) }} placeholder='To' value={to} />
          <input required onChange={e => { setPhone(e.target.value) }} placeholder='Phone' value={phone} />
          <input required onChange={e => { setAddress(e.target.value) }} placeholder='Address' value={address} />
        </div>
