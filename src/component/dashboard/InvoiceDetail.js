...
const InvoiceDetail = () => {
    ...
    const printInvoice = () => {
        ...
        html2canvas(input, { useCORS: true }) //capture image of bill
            .then((canvas) => {
                const imageData = canvas.toDataURL('image/png', 1.0) //data url
                const pdf = new jsPDF({       //pdf created
                ...
                pdf.addImage(imageData, 'PNG', 0, 0, pdfWidth, pdfHeight)   // pdf me image ko dal diya
